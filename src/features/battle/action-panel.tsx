...
export function ActionPanel({ onSelected, show }: ActionPanelProps) {
		...
		<AnimatePresence>
			{show && (
				...
				>
					...
					<figure className="-top-8 absolute left-[40%] z-20">
						<Sprite
							data={{
								part: '1',
					...
					<div className="absolute bottom-0 z-20 h-full w-[850px]">
