...
export default function Aim() {
	...
	return (
		<div className="absolute z-[3] flex h-screen w-screen flex-col items-center justify-center bg-black/10">
			<Vignette />
			<motion.div className="relative mb-20 flex w-[450px] items-center justify-center">
				<motion.div
					animate={{ rotate: 360, transition: { ease: 'linear', duration: 15, repeat: Number.POSITIVE_INFINITY } }}
			...
			<motion.div
				className="absolute bottom-10 z-[4] flex w-[120px] items-center justify-center"
				whileTap={{ scale: 0.8 }}
				onMouseDown={onHold}
				onMouseUp={onRelease}
			>
			...
			<div className="-translate-y-1/2 absolute top-1/2 left-32 z-[4] flex h-[60%] w-[150px] overflow-hidden">
